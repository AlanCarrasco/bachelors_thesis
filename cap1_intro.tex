...
Con lo anterior, para llevar a cabo el diseño, manufactura, prueba y vuelo de los cohetes experimentales se siguen códigos, normativas y estándares internacionales como referencia para resguardar la integridad física de los integrantes, apegarse a las mejores prácticas y no perjudicar a terceros que no estén involucrados en alguno de los procesos antes mencionados. Uno de los textos más predominantes en este ámbito es el \textit{NFPA 1127: Code for High Power Rocketry} (NFPA 1127, a partir de ahora) por la Asociación Nacional de Prevención de Incendios (NFPA, por sus siglas en inglés). Este texto aborda definiciones generales, requerimientos para la construcción y operación de cohetes de alta potencia, clasificación por potencia del motor, medidas de seguridad para los sitios de lanzamiento, componentes de los cohetes de alta potencia, entre otros conceptos relevantes para la definición de nuevos proyectos, al igual que la toma informada de decisiones para el desarrollo seguro del mismo.

\subsection{El cohete Sierra I}
El cohete Sierra I es un cohete híbrido experimental de alta potencia cuyo desarrollo estuvo a cargo de la asociación estudiantil Propulsión UNAM, de la Facultad de Ingeniería. Utilizó óxido nitroso (N$_2$O) como oxidante y parafina como propelente. El motor del Sierra I se diseñó para entregar un impulso total entre 11,916.00 y 14,067.27 [Ns], por lo que cae dentro de la categoría N \hl{[Insertar cita sobre clase de motores]}
% Mi hermano, hay mucho que pulir de este párrafo, las ideas están inconexas y solo parece un listado de afirmaciones. Vas bien con la recabación de datos, pero necesitamos sentir la historia, no solo describirla.
